...
format:
  revealjs:
    theme: clean.scss
    scrollable: true
    footer: "Lecture 2 - [Back to home](https://miguelfudolig-eab703-slides.share.connect.posit.cloud)"
    code-block-bg: true
...
::: callout-important
For MAC users, you need to install `XQuartz` first through the following link: <https://www.xquartz.org/> before installing `summarytools`.
:::
