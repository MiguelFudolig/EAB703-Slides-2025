...
::: callout-note
The confidence interval by `prop.test()` differs from the formula provided in the previous slide slightly, because it uses a different distribution to calculate the reliability coefficient.
:::
